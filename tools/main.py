...
product_types = ["liha", "piimatoode", "oli", "puuvili", "juurvili", "kuivaine", "kulmutatud", "maiustus"]
...
while True:
    ...
    while product_type not in product_types:
        product_type = input("Sisesta toodete ühtne tüüp (liha, piimatoode, oli, puuvili, juurvili, kuivaine, kylmutatud, maiustus): ")
